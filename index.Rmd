--- 
title: "Functional Data Analysis, Regression, Classification and Clustering using fda.usc  package "
...
link-citations: yes
github-repo: moviedo5/bookdown_fda_usc
...
2. Ferray and Vieu, (2006) processed FD from a nonparametric point of view  (normed or semi--normed functional spaces).
...
4.<span style="color:red">Interactive tools:  </span> 
+ <span style="color:red">StatFda</span>: exploratory analysis and functional regression models,http://www.statfda.com forand refund.shiny package
